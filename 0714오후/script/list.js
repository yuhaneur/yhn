...
const list = ["이순신","김유신","장보고","강해민","강미정",
"김선경","김재호","이채영","이재원","여상현","이예진"];

const addr =["대흥동","선화동","은행동","중리동","둔산1동",
"둔산2동","탄방동","태평동","문화동","갈마동","소재동","삼성동"];

var out="<h3>투게더 명단 ("+list.lengt+"명)</h3>";

out +="<table class='1ist_box'>";
}
for(var i=0;i<list.length;i++){//list배열의 이름만큼 반복}
    out +="<tr>";
    for(var k=1; k<=3; k++){
